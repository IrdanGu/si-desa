...
<form role="form" action="{{route(('agendaupdate'),$agenda->judul)}}" method="POST" enctype="multipart/form-data">
        <div class="card-body">
            @csrf
            @method('PUT')
                    ...
                    <label>Tanggal</label>
                      <div class="input-group date" id="reservationdate" data-target-input="nearest">
                        <div class="input-group-append" data-target="#reservationdate" data-toggle="datetimepicker">
                          ...
                          <input name="tanggal" type="date" class="form-control datetimepicker-input {{$errors->first('tanggal') ? "is-invalid": ""}} " data-target="#reservationdate" value="{{date('d-m-Y',strtotime($agenda->tanggal))}}">
                          <div class="invalid-feedback">
                ...
                <div class="form-group">
                    ...
                    <textarea class="textarea {{$errors->first('content') ? "is-invalid": ""}}" name="content" placeholder="Content" style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;">{{$agenda->content}}</textarea>
                    <div class="invalid-feedback">
